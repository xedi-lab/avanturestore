...
export default function ProductCard({ product, onBuy, onSelect }) {
  ...
  return (
    ...
    >
      <div className={styles.imageWrap} onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
        ...
        {badge && <div className={`${styles.badgeRibbon} ${styles[badge.ribbon]}`}>{badge.label}</div>}
      </div>
      ...
      <div className={styles.body}>
        ...
        <div className={styles.footer}>
          ...
          <button
            ...
            onClick={e => { e.stopPropagation(); product.inStock && onBuy?.(product) }}
